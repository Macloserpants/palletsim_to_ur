...
def on_motion(event):
    ...
    # width = layers[current_layer][dragging_box.width][2]
    # height = layers[current_layer][dragging_box.height][3]
    # box = layers[current_layer][id]
    # print(box)
...
def add_box():
    ...
    print(box_id)
    new_box = Box(10, 10, new_width, new_height, 0, box_id, current_layer)
